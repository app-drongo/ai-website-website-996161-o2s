...
const DEFAULT_FEATURES = {
  ...
  feature1Description:
    'Create professional invoices in seconds with customizable templates, automated calculations, and multi-currency support.',
  ...
  feature9Title: 'Tax Compliance & Backup',
  feature9Description:
    "Automatic tax calculations, quarterly reports, and secure cloud backup ensure you're always audit-ready.",
